...
{
    [Theory]
    [InlineData("--automation-open-settings", true, false, false, false)]
    [InlineData("--automation-open-about", false, true, false, false)]
    [InlineData("--automation-open-sample-overlay", false, false, true, false)]
    [InlineData("--automation-open-sample-recording-overlay", false, false, false, true)]
